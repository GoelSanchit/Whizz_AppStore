...
public class FreeCharge extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("FreeCharge");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeButtonEnabled(true);

        webView = (WebView) findViewById(R.id.webView1);
        // webView.setWebViewClient(new ourViewClient());
        webView.loadUrl("https://www.freecharge.in/m#!/home");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(FreeCharge.this);
            ...
            switch(keyCode)
            {
                case KeyEvent.KEYCODE_BACK:
                    if(webView.canGoBack()){
                        ...
                        Intent i = new Intent(FreeCharge.this,ListView4.class);
