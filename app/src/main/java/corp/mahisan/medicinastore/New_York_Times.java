...
public class New_York_Times extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://mobile.nytimes.com/international/");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(New_York_Times.this);
            ...
            switch(keyCode)
            {
                case KeyEvent.KEYCODE_BACK:
                    if(webView.canGoBack()){
                        ...
                        Intent i = new Intent(New_York_Times.this,ListView5.class);
