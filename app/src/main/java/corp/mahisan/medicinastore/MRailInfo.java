...
public class MRailInfo extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Rail Info");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeButtonEnabled(true);

        webView = (WebView) findViewById(R.id.webView1);
        // webView.setWebViewClient(new ourViewClient());
        webView.loadUrl("http://m.indiarailinfo.com/");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(MRailInfo.this);
            ...
            switch(keyCode)
            {
                case KeyEvent.KEYCODE_BACK:
                    if(webView.canGoBack()){
                        ...
                        Intent i = new Intent(MRailInfo.this,ListView1.class);
