...
public class ListView5 extends ActionBarActivity implements View.OnClickListener{
    ...
    public static int [] prgmImages={R.drawable.newshunt,R.drawable.toi,R.drawable.thehindu,R.drawable.newyorktimes,R.drawable.firstpost};
    public static String [] prgmNameList={"NewsHunt","Times Of India","The Hindu","New York Times","First Post"};
    public static  String[] prgmDesc={"NewsHunt App provides you reading all indian newspaper.","Times Of India App gives you all news from times of india newspaper from your local newspaper.","Hindu App fetches news from theHindu newspaper.","New York Times App Provides you information about new york news","First Post lets you post your news and many more things."};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.listview5);
        ...
        if (isInternetPresent) {
            lv.setAdapter(new CustomAdapter5(this, prgmNameList, prgmImages, prgmDesc));
        }else {
            // Internet connection is not present
            // Ask user to connect to Internet
            showAlertDialog(ListView5.this, "No Internet Connection",
    ...
    public void onBackPressed() {
        Intent i = new Intent(ListView5.this,MyActivity.class);
