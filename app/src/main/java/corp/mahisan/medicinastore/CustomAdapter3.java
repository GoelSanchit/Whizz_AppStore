...
public class CustomAdapter3 extends BaseAdapter{
    ...
    public CustomAdapter3(ListView3 mainActivity, String[] prgmNameList, int[] prgmImages ,String[] prgmDesc) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i==1){
                    context.startActivity(new Intent(context,Gmail.class));
                }
                if(i==2){
                    context.startActivity(new Intent(context,Twitter.class));
                }
                if(i==3){
                    context.startActivity(new Intent(context,Hot_Mail.class));
                }
                if(i==4){
                    context.startActivity(new Intent(context,Yahoo.class));
                }
