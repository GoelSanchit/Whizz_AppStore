...
public class UCRailway extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Indian Railway");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeButtonEnabled(true);

        webView = (WebView) findViewById(R.id.webView1);
        // webView.setWebViewClient(new ourViewClient());
        webView.loadUrl("http://train.ucweb.com");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(UCRailway.this);
            ...
            switch(keyCode)
            {
                case KeyEvent.KEYCODE_BACK:
                    if(webView.canGoBack()){
                        ...
                        Intent i = new Intent(UCRailway.this,ListView1.class);
