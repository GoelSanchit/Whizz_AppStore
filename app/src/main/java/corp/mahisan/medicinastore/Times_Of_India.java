...
public class Times_Of_India extends ActionBarActivity {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(Times_Of_India.this);
            ...
            switch(keyCode)
            {
                case KeyEvent.KEYCODE_BACK:
                    if(webView.canGoBack()){
                        ...
                        Intent i = new Intent(Times_Of_India.this,ListView5.class);
