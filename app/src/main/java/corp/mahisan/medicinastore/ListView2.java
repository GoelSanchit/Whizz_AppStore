...
public class ListView2 extends ActionBarActivity implements View.OnClickListener{
    ...
    public static int [] prgmImages={R.drawable.prescribe_medicines,R.drawable.disease_info,R.drawable.generic_medicines,R.drawable.theraphy,R.drawable.quit_smoking,R.drawable.moodscanner,R.drawable.hypnotize,R.drawable.fringe_science};
    public static String [] prgmNameList={"Prescribe Medicines","Disease Info","Generic Medicines","Theraphy","Quit Smoking","Mood Scanner","Hypnotize Relax","Fringe"};
    public static  String[] prgmDesc={"Fetch Medicines From your typed Disease","This Application Give you the information of disease you type","Generic Medicines gives you the information of medicine & International and Indian Substitute","This Theraphy App gives you the information about Test performed in medical science.","Quit Smoking App Tells you how much prone you are in keep smoking.","Mood Scanner App will tell you the mood on random basis","Hypnotisim is an art which make human to relax it's reflexes","Fringe Science reveals some secrets that are wonderful to known"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Medicina AppStore");
        ...
        if (isInternetPresent) {
            lv.setAdapter(new CustomAdapter2(this, prgmNameList, prgmImages, prgmDesc));
        }else {
            // Internet connection is not present
            // Ask user to connect to Internet
            showAlertDialog(ListView2.this, "No Internet Connection",
    ...
    public void onBackPressed() {
        Intent i = new Intent(ListView2.this,MyActivity.class);
