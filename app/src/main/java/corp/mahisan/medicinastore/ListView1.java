...
public class ListView1 extends ActionBarActivity implements View.OnClickListener{
    ...
    public static int [] prgmImages={R.drawable.indianrailway,R.drawable.map,R.drawable.delhimetro,R.drawable.mumbailocal,R.drawable.kolkatalocal,R.drawable.redbus,R.drawable.yatra};
    public static String [] prgmNameList={"Indian Railway","Rail Info","Delhi Metro","Mumbai Local","Kolkata Local","Red Bus","Air Ticket"};
    public static  String[] prgmDesc={"This Fetches the PNR & Train Enquiry schedule","Track Your Train in Maps & Atlas","Directions From Delhi Metro App","Find Your Local Train in Mumbai & Track certain Locations","Find Your Local Train in Kolkata & Track certain Locations","Find Your Bus For Certain Locations Like Delhi,Mumbai,Pune etc","Book Flight Tickets & Hotels From Yatra App"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isInternetPresent) {
            lv.setAdapter(new CustomAdapter1(this, prgmNameList, prgmImages, prgmDesc));
        }else {
            // Internet connection is not present
            // Ask user to connect to Internet
            showAlertDialog(ListView1.this, "No Internet Connection",
    ...
    public void onBackPressed() {
        Intent i = new Intent(ListView1.this,MyActivity.class);
